   ...
   <nav>
     ...
     <transition name="mobile-nav">
       <ul v-show="mobileNav" class="dropdown-nav">
         ...
         <li @click="toggleMobileNav"><router-link class="link" :to="{name: 'About'}">About</router-link></li>
         <li @click="toggleMobileNav"><router-link class="link" :to="{name: 'Portfolio'}">Portfolio</router-link></li>
         <li @click="toggleMobileNav"><router-link class="link" :to="{name: 'Contact'}">Contact</router-link></li>
       </ul>
     </transition>
   </nav>
  </header>
